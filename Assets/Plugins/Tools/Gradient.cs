...
namespace Tools
{
    ...
    {
        [SerializeField] private Type gradientType;
        [SerializeField] private Blend blendMode = Blend.Multiply;
        [Tooltip("Add vertices to display complex gradients. Turn off if your shape is already very complex, like text.")]
        [SerializeField] private bool modifyVertices = true;
        [Range(-1, 1)]
        [SerializeField] private float offset = 0f;
        [Range(0.1f, 10)]
        [SerializeField] private float zoom = 1f;
        [SerializeField] private UnityEngine.Gradient effectGradient = 
            new () { colorKeys = new [] { new GradientColorKey(Color.black, 0), new GradientColorKey(Color.white, 1) } };
        ...
        private Type GradientType => gradientType;

        private bool ModifyVertices => modifyVertices;
